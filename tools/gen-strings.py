...
S = [
    ...
    ("Hints",              "Click - copy · Double click or Enter - paste · Alt+1...9 - quick pick · Ctrl+P - pin · Shift+Delete - remove · Esc - close",
                           "Клик — скопировать · Двойной клик или Enter — вставить · Alt+1…9 — быстрый выбор · Ctrl+P — закрепить · Shift+Delete — удалить · Esc — закрыть", ""),
